...
def load_high_score():
    ...
    hi_score_file = open("Hi_score.txt", "r")  # fixed file name to match consistently
...
def save_high_score(high_score):
    high_score_file = open("Hi_score.txt", 'w')  # fixed file name to match consistently
...
while True:
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            save_high_score(high_score)  # save high score on quit
            pygame.quit()
            sys.exit()
